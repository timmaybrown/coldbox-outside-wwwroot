component{
	...
	function configure(){
		...
		coldbox = {
			//Application Setup
			appName 				= "Coldbox Outside Webroot",
			eventName 				= "event",
		...
		interceptors = [
			//SES
			{class="coldbox.system.interceptors.SES", properties={ configFile = "/app/config/Routes.cfm" }	}
			,{ class="app.interceptors.ErrorInterceptor", properties={} }																	//GLOBAL ERROR HANDLER
			
		];

		// flash scope configuration - to turn off SESSION scope for api
		/* flash = {
			scope = "app.models.DummyFlash"
		}; */
		/*
